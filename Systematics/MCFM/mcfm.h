...
// Sat Jul  7 23:39:57 2012 by ROOT version 5.28/00a
// from TTree h10/h10
// found on file: ZZlept_tota_CT10.00_0___0___test.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ZZlept_tota_CT10.00_0___0___test.root");
      if (!f) {
         f = new TFile("ZZlept_tota_CT10.00_0___0___test.root");
      }
